...
<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0" id="location">
  <tr>
    ...
    <td width="5%" align="center">小队目录</td>
...
<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0" id="message">
  <tr>
    ...
    <td width="6%" align="center"><a href="teampostpub.jsp"><img src="images/btnpub.gif" width="60" height="25" border="0" /></a></td>
  </tr>
</table>
...
<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0" id="postlist">
  <tr>
    ...
    <td width="70%"><strong>小队名字</strong></td>
    <td width="16%" align="center"><strong>小队队长</strong></td>
    <td width="10%" align="center"><strong>浏览/回复</strong></td>
  </tr>  
  <c:forEach var="one" items="${session.teamlist}">
  <s:form id="teamform" method="post" action="teamshowOne">
  <tr bgcolor="#F5F5F5">
    <input type="hidden" name="fmember" value="${user.getUsername()}"/>
    <td height="40" align="center" class="xian"><img src="images/topic.gif" width="17" height="17" /></td>
    <td class="xian"><input type="hidden" name="fteamname" value="${one.getTeamname()}"/><input type="submit" class="teamsubmit" value="${one.getTeamname()}" class=""/>&nbsp;&nbsp;<img src="images/new.gif" width="26" height="9" align="absmiddle" /></td>
    <td align="center" class="xian">${one.getTeamleader()}</td>
